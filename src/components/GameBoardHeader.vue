...
<template>
  <div class="game-header">
    ...
    <div class="game-header-top">
      ...
      <button
        class="btn btn-seagreen btn-icon game-header-button"
        @click="gameStore.settingsDialog?.showModal()"
      >
        <svg class="game-header-icon" width="24" height="24" viewBox="0 0 24 24">
          <path
      ...
      >
        ...
        <button
          class="btn btn-seagreen btn-icon"
          @click="gameStore.setupGame(GameDifficulty.Normal)"
        >
          <svg class="game-header-icon" width="24" height="24" viewBox="0 0 24 24">
            <path
        ...
        <button class="btn btn-seagreen btn-icon" @click="gameStore.setupGame(GameDifficulty.Hard)">
          <svg class="game-header-icon" width="24" height="24" viewBox="0 0 24 24">
            <path
